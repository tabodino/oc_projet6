...
use OC\BackBundle\Helper\ImageResizer;
 ...
 * Image
 *
 * @ORM\Table(name="oc6_image")
 * @ORM\Entity(repositoryClass="OC\BackBundle\Repository\ImageRepository")
...
class Image
{
    ...
    {
        return __DIR__.'/../../../../web/uploads/img/thumbs/';
    }
}
